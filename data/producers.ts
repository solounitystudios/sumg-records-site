...
export const producers: Producer[] = [
  {
    name: "NightWire",
    slug: "nightwire",
    image: "/producer-assets/nightwire.png",
    shortDescription:
      "Moody, layered construction across low-end pressure and ambient texture.",
    fullBio:
  ...
  },
  {
    name: "Ironlight",
    slug: "ironlight",
    image: "/producer-assets/ironlight.png",
    shortDescription:
      "Hard-edged production with disciplined arrangement and impact-focused drums.",
    fullBio:
